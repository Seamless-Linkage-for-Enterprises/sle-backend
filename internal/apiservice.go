...
func WriteMessage(c *gin.Context, v string) (int, error) {
	c.JSON(http.StatusOK, ApiMessage{Message: v})
	return 0, nil
}

func WriteData(c *gin.Context, v any) (int, error) {
	c.JSON(http.StatusOK, ApiData{Data: v})
	return 0, nil
}
